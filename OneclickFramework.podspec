#
# Be sure to run `pod lib lint OneclickFramework.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of OneclickFramework.'
...
TODO: Add long description of the pod here.
  ...
  s.source_files = 'OneclickFramework/Classes/**/*'
  
  # s.resource_bundles = {
  #   'OneclickFramework' => ['OneclickFramework/Assets/*.png']
  # }
